...
interface DonutStoneCrowdsaleInterface extends ethers.utils.Interface {
  functions: {
...
export class DonutStoneCrowdsale extends BaseContract {
  ...
  interface: DonutStoneCrowdsaleInterface;
