...
export default function CardHomeText() {
  ...
  return (
    <p>
        ...
        required infrastructure has been implemented, and so you can buy donutstones below completely free. To show your support for the 
